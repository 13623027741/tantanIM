...
@implementation KDGuillotineMenu
...
//        self.menuColor = [UIColor colorWithRed:65.0 / 255.0 green:62.f / 255.f blue:79.f / 255.f alpha:1];
        self.menuColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.9];
...
- (void)setupMenu {
	...
	if (self.menuStyle == KDGuillotineMenuStyleCollection) {
...
- (void)openMenu{
    ...
    id<KDGuillotineMenuDelegate> strongDelegate = self.delegate;
